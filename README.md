...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/1E9xAOhb4YBSd0znq3hzudmV2eac7FX1MOdXLvDcbtFo/edit#gid=0) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi *-7.36E-03*t^2 + 0.141*t + 0.014*. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Yardım: bir tanesi ivme ile ilgili, bir tanesi ilk hız ile, diğeri konum ile ilgili).  Sizce niçin a'nın değeri negatif?  
c katsayısı nesnenin başlangıç konumunu, b başlangıç hızı, a ise ivmesinin yarısıdır(Bunları şu şekilde açıklarız: polinomun türevi bize hızı verir, P(x)=ax^2+bx+c ise P'(x)=2ax+b olacağına göre b sabit terimdir, yani başlangıç hızıdır. Burada P''(x)=2a olur, bu polinom 1.dereceden bir sabit polinom olduğuna göre ve ivmeyi verdiğine göre ivme 2a dır, yani a ivmenin yarısıdır. 9.sınıf seviyesinde nasıl açıklanır bilemiyorum.). a pozitif olsaydı grafik sürekli artacaktı, çünkü artma hızı artacaktı, ama atılan cisim bir süre sonra duracağından bu olamaz, yani a negatif veya 0 olmak zorunda.

b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir?  
Evet. Bir üstteki yanıtta açıklamıştım(P''(x) sabit olduğuna göre evet.).
...
Atılış hızından kasıt başlangıç hızıysa, b başlangıç hızı olduğuna göre b değişirdi.
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1UHtRAfZGIUjn5Gv6qUnc23RkIQR7ven6f_It5UZzfmk/edit#gid=0) link veriniz.
